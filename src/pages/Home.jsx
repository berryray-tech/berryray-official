        ...
        <section className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center py-8 lg:py-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              <a
                href="https://your-external-form-link-here.com"  // CHANGE THIS TO YOUR ACTUAL FORM LINK
                target="_blank"
              ...
              >
                ...
                <span className="font-semibold text-base sm:text-lg">Fill Application Form</span>
